...
namespace car_insurance_mob.Services
{
    ...
    {
        public static Passport pass1 = new Passport(Guid.NewGuid(), "dfgdfgdfgdf", DateTime.Now, "1111", "1111", "508349","Иванов Иван Иванович",false, DateTime.Now, "Moscow", "Ленина 11");
